...
extern "C"
{
	void sphero_RIT_IRQHandler(void);
	void sphero_EINT3_IRQHandler(void);
	void sphero_UART2_IRQHandler(void);
	//void sphero_UART3_IRQHandler(void);
}
...
static isr_func_t g_isr_array[] = {
        ...
        sphero_UART2_IRQHandler,
		UART3_IRQHandler,       // 24, 0x60 - UART3
		//sphero_UART3_IRQHandler,
        ...
        sphero_EINT3_IRQHandler,       // 37, 0x94 - EINT3
		...
		sphero_RIT_IRQHandler,         // 45, 0xb4 - RITINT
